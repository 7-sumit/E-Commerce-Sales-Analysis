...
## Problem Statement
1. Extracting e-commerce data from databases using SQL.
2. Preprocessing and transforming data with Python.
3. Loading processed data into Power BI using python data cleaning script.
4. Creating interactive Power BI reports for sales analysis.
5. Streamline data handling for improved decision-making.
...
8. Created KPIs and visualizations for revenue, orders, customer segmentation, delivery performance, and product category analysis.
9. Delivered actionable insights to support data-driven decision-making and improve overall business performance.
